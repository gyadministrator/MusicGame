...
public class SplashActivity extends BaseActivity {
    ...
    private static final String APPID = "dcb8960a94e1177f";
    private static final String APPSECRET = "993061c35ddf85e2";
    ...
    private void setupSplashAd() {
        ...
        // 设置跳转的窗口类
        splashViewSettings.setTargetClass(StartActivity.class);
        // 设置开屏的容器
